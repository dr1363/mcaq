      ...
      <div className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="cyber-card p-6 rounded-sm mb-6">
            ...
            <p className="text-textMuted mb-4">Write a Python script to crack MD5 password hashes</p>
            <div className="flex items-center gap-3">
              <span className="text-xs font-mono px-2 py-1 rounded-sm font-bold bg-primary/20 text-primary">Beginner</span>
              <span className="text-xs font-mono bg-secondary/20 text-secondary px-2 py-1 rounded-sm uppercase">python</span>
              <span className="text-xs font-mono text-primary">+50 XP</span>
            </div>
          </div>
            ...
            <div>
              <div className="cyber-card rounded-sm overflow-hidden">
                <div className="bg-surface p-3 border-b border-white/10 flex items-center justify-between">
                  ...
                  <span className="text-xs font-mono text-secondary uppercase">python</span>
                </div>
                <Textarea
                  value={code}
